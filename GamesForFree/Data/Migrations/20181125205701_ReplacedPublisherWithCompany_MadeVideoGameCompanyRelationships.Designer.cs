...
namespace GamesForFree.Data.Migrations
{
    ...
    [Migration("20181125205701_ReplacedPublisherWithCompany_MadeVideoGameCompanyRelationships")]
    partial class ReplacedPublisherWithCompany_MadeVideoGameCompanyRelationships
    {
            ...
            modelBuilder.Entity("GamesForFree.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTimeOffset(new DateTime(2018, 11, 25, 15, 57, 1, 36, DateTimeKind.Unspecified), new TimeSpan(0, -5, 0, 0, 0)), Email = "amurchison@email.com", FirstName = "Angel", GamePointBalance = 0m, LastName = "Murchison", Password = "password", UserName = "amurchison" }
                    );
                });
